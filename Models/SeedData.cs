...
public class SeedData
{
	...
	{
		using var context = new RecettesAPIContext(
		...
		var cookiesCategory = new Categorie
		{
			name = "Cookies",
			photo_url = "https://www.telegraph.co.uk/content/dam/Travel/2019/January/france-food.jpg?imwidth=1400"
		};

		var smoothiesCategory = new Categorie
		{
			name = "Smoothies",
		...
		context.Recipe.AddRange(oatmealCookiesRecipe, smoothieTripleBerryRecipe, veganCookiesRecipe, pumpkinSpiceCookiesRecipe, browniesRecipe, fishTacosRecipe, chickenFajitasRecipe, buffaloPizzaRecipe, classicLasagnaRecipe, carbonaraRecipe, lazaniaRecipe);
